...
def trackMultipleObjects():
    ...
    while True:
        ...
        for carID in carTracker.keys():
            ...
            cv2.putText(resultImage, str(carID), (tx,ty-5), cv2.FONT_HERSHEY_DUPLEX, 1, (255, 0, 0), 1)
            ...
            if carID not in startTracker and mark2 > ty+th > mark1 and ty < mark1:
                ...
                if speed > speedLimit:
                    ...
                    cv2.rectangle(resultImage, (tx, ty), (tx + tw, ty + th), (0, 0, 255), 2)
                    cv2.putText(resultImage, str(carID), (tx,ty-5), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255), 1)
                    cv2.putText(resultImage, "OverSpeed", (tx+50,ty-5), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255), 1)
                    ...
                    # cv2.putText(resultImage, "OverSpeed", (tx+10,ty-5), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 255, 0), 1)
